...
👋 Building a blog? Check out our quickstart guide [here](/guides/create-a-blog).
...
1. Go to [example-page](https://github.com/shadcn/next-mdx/tree/master/examples/example-page)
